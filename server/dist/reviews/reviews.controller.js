...
let ReviewsController = class ReviewsController {
    ...
    async createReview(req, orderId, data) {
        return this.reviewsService.createReview(req.user.userId, Number(orderId), data);
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReviewsController.prototype, "getMerchantReviews", null);
